package com.oop.inteliframework.dependency.logging;
...
public class Logger {
  ...
  /**
   * Gets whether messages matching the provided level can be logged under the current log level
   * setting.
   *
   * <p>Returns true if provided log level is equal to or more severe than the logger's configured
   * log level.
   *
   ...
   *
   * <p>If the provided log level is less severe than the logger's configured log level, this
   * message won't be logged.
   *
   ...
   *
   * <p>If the logger's configured log level is more severe than {@link LogLevel#DEBUG}, this
   * message won't be logged.
   *
   * @param message the message to log
   */
   ...
   *
   * <p>If the logger's configured log level is more severe than {@link LogLevel#INFO}, this message
   * won't be logged.
   *
   * @param message the message to log
   */
   ...
   *
   * <p>If the logger's configured log level is more severe than {@link LogLevel#WARN}, this message
   * won't be logged.
   *
   * @param message the message to log
   */
