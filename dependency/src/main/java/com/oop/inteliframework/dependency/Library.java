...
public class Library {
  ...
  private Library(
    ...
    this.path = path + ".jar";
    relocatedPath = artifactId + "-relocated.jar";
  }
  ...
  public static class Builder {
    ...
    public Builder classesPath(String classesPath) {
      this.classesPath = requireNonNull(classesPath, "classes path");
      return this;
    }
