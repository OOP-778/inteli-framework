...
import com.oop.inteliframework.dependency.logging.Logger;
...
import com.oop.inteliframework.dependency.relocation.RelocationHelper;
 ...
 * server itself.
 *
 * @see com.oop.inteliframework.dependency.Library
 */
public abstract class LibraryManager {
   ...
   *
   * <p>By setting this value, the library manager's logger will not log any messages with a level
   * less severe than the configured level. This can be useful for silencing the download and
   * relocation logging.
   *
   * <p>Setting this value to {@link LogLevel#WARN} would silence informational logging but still
   * print important things like invalid checksum warnings.
   *
   ...
   */
  public Collection<String> resolveLibrary(com.oop.inteliframework.dependency.Library library) {
   ...
   * @see #loadLibrary(com.oop.inteliframework.dependency.Library)
   */
  public Path downloadLibrary(com.oop.inteliframework.dependency.Library library) {
    Path file = saveDirectory.resolve(library.getArtifactId() + ".jar");
   ...
   * @see #downloadLibrary(com.oop.inteliframework.dependency.Library)
   */
  public void loadLibrary(com.oop.inteliframework.dependency.Library library) {
