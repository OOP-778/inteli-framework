package com.oop.inteliframework.dependency.relocation;
...
public class Relocation {
  ...
  /**
   * Provides an alternative method of creating a {@link Relocation}. This builder may be more
   * intuitive for configuring relocations that also have any includes or excludes.
   */
