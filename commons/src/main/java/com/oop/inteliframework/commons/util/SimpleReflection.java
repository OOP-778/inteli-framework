...
public final class SimpleReflection {
  ...
  public static Constructor<?> getConstructor(Class<?> clazz, Class<?>... parameterTypes) {
    ...
    for (Constructor<?> constructor :
      ...
      if (!compareClasses(parameterTypes, constructor.getParameterTypes())) continue;
  ...
  public static Constructor<?> getConstructor(
      String className, Package packageType, Class<?>... parameterTypes) throws Exception {
  ...
  public static Object initializeObject(String className, Package packageType, Object... arguments)
      throws Exception {
  ...
  public static Method getMethod(Class<?> clazz, String methodName, Class<?>... parameterTypes) {
    ...
    for (Method method : merge(clazz.getMethods(), clazz.getDeclaredMethods())) {
      if (!method.getName().equalsIgnoreCase(methodName)
          || !compareClasses(parameterTypes, method.getParameterTypes())) continue;
  ...
  public static Method getMethod(
      String className, Package packageType, String methodName, Class<?>... parameterTypes)
      throws Exception {
  ...
  public static <T> Field getFieldAnnotatedBy(
      Class<?> target, Class<? extends Annotation> annotationClass) {
  ...
  public static Field getField(String className, Package packageType, String fieldName)
      throws Exception {
    return getField(packageType.getClass(className), fieldName);
  }

  public static Method getTypedMethod(
    ...
    throw new IllegalStateException(
        StringFormat.format("Unable to find method {} ({}).", methodName, Arrays.asList(params)));
  }
  ...
  public static class Player {
    ...
    private static Class<?> CRAFT_PLAYER_CLASS,
        ...
        PACKET_CLASS;
    private static Method SEND_PACKET_METHOD, GET_HANDLE_METHOD;
  ...
  public static class PrimitivesCaster {
    ...
    static {
      casters.put(
          int.class,
          in -> {
            if (in.contains(".")) return Math.round(Double.parseDouble(in));
      ...
      casters.put(
          ...
          in -> {
            if (in.contains(".")) return Math.round(Double.parseDouble(in));
            else return Short.parseShort(in);
          });
    ...
    public static Object cast(Class to, Object what) {
