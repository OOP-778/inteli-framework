...
public class NPCLibOptions {
   ...
   * Programmers may choose between using the PlayerMoveEvent or a periodic task. <br>
   * <br>
   * Note that NPCLib will always use events such as the PlayerTeleportEvent and
   * PlayerChangedWorldEvent in addition to the specified option.
   *
