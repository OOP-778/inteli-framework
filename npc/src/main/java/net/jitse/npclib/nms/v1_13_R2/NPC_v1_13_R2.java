...
public class NPC_v1_13_R2 extends NPCBase {
  ...
  public NPC_v1_13_R2(InteliNPCModule instance, List<String> lines) {
  ...
  public Hologram getPlayerHologram(Player player) {
    ...
    if (holo == null) {
      holo =
          new Hologram(
              MinecraftVersion.V1_13_R2, location.clone().add(0, 0.5, 0), getPlayerLines(player));
    }
  ...
  public void sendEquipmentPacket(Player player, NPCSlot slot, boolean auto) {
    ...
    PacketPlayOutEntityEquipment packet =
        new PacketPlayOutEntityEquipment(entityId, nmsSlot, CraftItemStack.asNMSCopy(item));
    playerConnection.sendPacket(packet);
  }
