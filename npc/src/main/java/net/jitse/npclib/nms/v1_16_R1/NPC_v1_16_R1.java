...
public class NPC_v1_16_R1 extends NPCBase {
  ...
  public NPC_v1_16_R1(InteliNPCModule instance, List<String> lines) {
  ...
  public Hologram getPlayerHologram(Player player) {
    ...
    if (holo == null) {
      holo =
          new Hologram(
              MinecraftVersion.V1_16_R1, location.clone().add(0, 0.5, 0), getPlayerLines(player));
    }
  ...
  public void sendEquipmentPacket(Player player, NPCSlot slot, boolean auto) {
    ...
    Pair<EnumItemSlot, net.minecraft.server.v1_16_R1.ItemStack> pair =
