...
public class NPC_v1_16_R2 extends NPCBase {
  ...
  public NPC_v1_16_R2(InteliNPCModule instance, List<String> lines) {
  ...
  public Hologram getHologram(Player player) {
    ...
    if (hologram == null)
      hologram =
          new Hologram(MinecraftVersion.V1_16_R2, location.clone().add(0, 0.5, 0), getText(player));
  ...
  public void sendEquipmentPacket(Player player, NPCSlot slot, boolean auto) {
    ...
    Pair<EnumItemSlot, net.minecraft.server.v1_16_R2.ItemStack> pair =
