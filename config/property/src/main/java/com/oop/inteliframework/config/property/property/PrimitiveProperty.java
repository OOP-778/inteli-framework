...
public class PrimitiveProperty<T> implements Property<T> {
  ...
  public void fromNode(Node node) {
    Preconditions.checkArgument(
        node instanceof ValueNode, "Primitive property only accepts ValueNodes!");
  ...
  public static class Mutable<T> extends PrimitiveProperty<T>
      implements MutableProperty<T, Mutable<T>> {
