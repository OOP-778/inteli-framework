...
import com.oop.inteliframework.menu.util.TriConsumer;
...
public class Animation<T> implements Cloneable {
  ...
  @Setter @Getter private int frames;
  ...
  */
  @Setter @Getter private boolean shouldGoBack = false;
  ...
  @Getter private boolean isGoingBack = false;
