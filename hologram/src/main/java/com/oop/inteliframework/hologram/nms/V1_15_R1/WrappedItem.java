...
import static com.oop.inteliframework.hologram.nms.V1_15_R1.Helper.constructEntityMetaPacket;
...
public class WrappedItem {
    ...
    public net.minecraft.server.v1_15_R1.ItemStack getItem(Player player) {
