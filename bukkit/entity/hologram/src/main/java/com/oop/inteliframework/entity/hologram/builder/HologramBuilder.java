package com.oop.inteliframework.entity.hologram.builder;
...
import com.oop.inteliframework.entity.hologram.line.HologramItem;
...
public class HologramBuilder {
  ...
  @Setter private long refreshRate = -1;
  ...
  public Hologram build() {
    ...
    Preconditions.checkArgument(refreshRate != -1, "Refresh rate is set to -1, cannot be!");
    ...
    for (ViewBuilder viewBuilder : views) {
      ...
      if (viewBuilder.refreshRate != -1) view.setRefreshRate(viewBuilder.refreshRate);
      else view.setRefreshRate(refreshRate);
  ...
  public static class LinesBuilder {
    ...
    private @NonNull final Consumer<HologramLine> whenFinished;
