...
import static com.oop.inteliframework.entity.armorstand.nms.V1_8_R3.Helper.constructEntityMetaPacket;
...
public class WrappedItem {
  ...
  public net.minecraft.server.v1_8_R3.ItemStack getItem(Player player) {
