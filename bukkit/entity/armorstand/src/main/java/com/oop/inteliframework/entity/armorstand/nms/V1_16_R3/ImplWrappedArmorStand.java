...
import static com.oop.inteliframework.entity.armorstand.nms.V1_16_R3.Helper.sendPacket;
...
public class ImplWrappedArmorStand implements WrappedArmorStand {
  ...
  public void outputLocation() {
    ...
    if (move)
      ...
      if (attachedItem != null) {
        attachedItem.entityItem.setLocation(
            location.getX(),
            location.getY(),
            location.getZ(),
            location.getYaw(),
  ...
  public void setupItem() {
    ...
    SimpleReflection.getField(Entity.class, "vehicle").set(attachedItem.entityItem, entity);
  }
