...
import static com.oop.inteliframework.entity.armorstand.nms.V1_8_R3.Helper.sendPacket;
...
public class ImplWrappedArmorStand implements WrappedArmorStand {
  ...
  public ImplWrappedArmorStand(Location location, Supplier<Collection<Player>> viewersSupplier) {
    entity =
  ...
  public void spawn(Player player) {
    ...
    packetList.add(
        constructEntityMetaPacket(getDataWatcher(player).getWatchableObjects(), entity.getId()));
