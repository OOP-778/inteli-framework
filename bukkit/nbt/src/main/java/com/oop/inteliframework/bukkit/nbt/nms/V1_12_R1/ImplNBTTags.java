package com.oop.inteliframework.bukkit.nbt.nms.V1_12_R1;
...
public class ImplNBTTags implements NBTTags {
  ...
  public ListTag convertListTag(NBTTagList tag) {
    ListTag converted = ListTag.createUnchecked(TagIdToClass.getClassFromId(tag.g()));
    if (tag.isEmpty()) {
      return converted;
    }
  ...
  public Tag<?> convertSimpleTag(NBTBase tag) {
    if (tag instanceof NBTTagString) {
      return new StringTag(((NBTTagString) tag).c_());
    }
  ...
  public ItemStack setItemStackTag(ItemStack itemStack, CompoundTag compoundTag) {
    final net.minecraft.server.v1_12_R1.ItemStack nmsItem = CraftItemStack.asNMSCopy(itemStack);
