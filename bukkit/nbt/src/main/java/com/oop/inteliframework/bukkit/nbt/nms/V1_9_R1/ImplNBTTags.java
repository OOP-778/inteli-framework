package com.oop.inteliframework.bukkit.nbt.nms.V1_9_R1;
...
public class ImplNBTTags implements NBTTags {
  ...
  public CompoundTag fromItemStack(ItemStack itemStack) {
    final net.minecraft.server.v1_9_R1.ItemStack nmsCopy = CraftItemStack.asNMSCopy(itemStack);
  ...
  public Tag<?> convertSimpleTag(NBTBase tag) {
    ...
    if (tag instanceof NBTTagByte) {
      return new ByteTag(((NBTTagByte) tag).f());
    }
  ...
  public ItemStack setItemStackTag(ItemStack itemStack, CompoundTag compoundTag) {
    final net.minecraft.server.v1_9_R1.ItemStack nmsItem = CraftItemStack.asNMSCopy(itemStack);
