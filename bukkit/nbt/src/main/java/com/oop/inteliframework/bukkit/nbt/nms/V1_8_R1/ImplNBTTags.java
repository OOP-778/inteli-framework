package com.oop.inteliframework.bukkit.nbt.nms.V1_8_R1;
...
public class ImplNBTTags implements NBTTags {
  ...
  public CompoundTag fromItemStack(ItemStack itemStack) {
    final net.minecraft.server.v1_8_R1.ItemStack nmsCopy = CraftItemStack.asNMSCopy(itemStack);
  ...
  public CompoundTag convertCompound(NBTTagCompound nms) {
    ...
    for (String nbtKey : (Set<String>) nms.c()) {
  ...
  public ItemStack setItemStackTag(ItemStack itemStack, CompoundTag compoundTag) {
    final net.minecraft.server.v1_8_R1.ItemStack nmsItem = CraftItemStack.asNMSCopy(itemStack);
