...
public class LittleEndianNBTOutputStream implements DataOutput, NBTOutput, MaxDepthIO, Closeable {
  ...
  private static Map<
          Byte, ExceptionTriConsumer<LittleEndianNBTOutputStream, Tag<?>, Integer, IOException>>
      writers = new HashMap<>();
  ...
  private static void writeByteArray(LittleEndianNBTOutputStream out, Tag<?> tag)
      throws IOException {
    out.writeInt(((ByteArrayTag) tag).length());
    out.write(((ByteArrayTag) tag).getValue());
  }

  private static void writeIntArray(LittleEndianNBTOutputStream out, Tag<?> tag)
      throws IOException {
  ...
  private static void writeLongArray(LittleEndianNBTOutputStream out, Tag<?> tag)
      throws IOException {
  ...
  private static void writeList(LittleEndianNBTOutputStream out, Tag<?> tag, int maxDepth)
      throws IOException {
  ...
  private static void writeCompound(LittleEndianNBTOutputStream out, Tag<?> tag, int maxDepth)
      throws IOException {
