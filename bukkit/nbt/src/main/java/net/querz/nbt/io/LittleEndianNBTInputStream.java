...
public class LittleEndianNBTInputStream implements DataInput, NBTInput, MaxDepthIO, Closeable {
  ...
  private static Map<
          Byte,
          ExceptionBiFunction<LittleEndianNBTInputStream, Integer, ? extends Tag<?>, IOException>>
      readers = new HashMap<>();
  ...
  private static ListTag<?> readListTag(LittleEndianNBTInputStream in, int maxDepth)
      throws IOException {
  ...
  private static CompoundTag readCompound(LittleEndianNBTInputStream in, int maxDepth)
      throws IOException {
