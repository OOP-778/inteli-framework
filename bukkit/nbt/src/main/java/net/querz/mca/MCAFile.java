...
public class MCAFile {
  ...
  /**
   * MCAFile represents a world save file used by Minecraft to store world data on the hard drive.
   * This constructor needs the x- and z-coordinates of the stored region, which can usually be
   * taken from the file name {@code r.x.z.mca}
   *
  ...
  /**
   * Calculates the index of a chunk from its x- and z-coordinates in this region. This works with
  ...
  /**
   * Reads an .mca file from a {@code RandomAccessFile} into this object. This method does not
   * perform any cleanups on the data.
   *
  ...
  /**
   * Serializes this object to an .mca file. This method does not perform any cleanups on the data.
   *
   * @param raf The {@code RandomAccessFile} to write to.
   * @param changeLastUpdate Whether it should update all timestamps that show when this file was
   *     last updated.
   * @return The amount of chunks written to the file.
   * @throws IOException If something went wrong during serialization.
   */
  ...
  /**
   * Set a specific Chunk at a specific chunk location. The x- and z-value can be absolute chunk
   * coordinates or they can be relative to the region origin.
   *
   * @param chunkX The x-coordinate of the Chunk.
   * @param chunkZ The z-coordinate of the Chunk.
   * @param chunk The chunk to be set.
  ...
  /**
   * Set a block state at a specific block location. The block coordinates can be absolute
   * coordinates or they can be relative to the region.
   *
   * @param blockX The x-coordinate of the block.
   * @param blockY The y-coordinate of the block.
   * @param blockZ The z-coordinate of the block.
   * @param state The block state to be set.
   * @param cleanup Whether the Palette and the BLockStates should be recalculated after adding the
   *     block state.
   */
  ...
  /**
   * Fetches a block state at a specific block location. The block coordinates can be absolute
   * coordinates or they can be relative to the region.
   *
   * @param blockX The x-coordinate of the block.
   * @param blockY The y-coordinate of the block.
