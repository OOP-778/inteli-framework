...
public class VersionedAdapters {
    public static final String version = getServer().getClass().getPackage().getName().split("\\.")[3].substring(1);
    private static final Map<Class, VersionedAdapter> loadedAdapters = new HashMap<>();
    private static final Map<Class, Class<? extends VersionedAdapter>> loadedAdaptersClasses = new HashMap<>();
    ...
    /**
     * Loads an versioned adapter
     * Example of versioned package is V1_8_R3
     *
     * @param basepath package of where to look for it
     * @param <T>      the type of the adapter
     * @return optional adapter
     */
    public static <T extends VersionedAdapter> Optional<T> load(String basepath, String className, Class<T> baseClass) {
    ...
    /**
     * Loads an versioned adapter class
     * Example of versioned package is V1_8_R3
     *
     * @param basepath package of where to look for it
     * @param <T>      the type of the adapter
     * @return optional adapter
     */
    public static <T extends VersionedAdapter> Optional<Class<T>> loadClass(String basepath, String className, Class<T> baseClass) {
        // BasePath + version + ClassName
