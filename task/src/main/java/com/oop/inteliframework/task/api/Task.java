...
public interface Task<T extends Task> {
   ...
   * Task body (Required)
   *
   * @param consumer Task body which will be
   ...
   *
   * @param predicate If predicate is true, task
   ...
   * Do after complete
   *
   * @param consumer After task will complete his work,
   ...
   * Run task times
   *
   * @param times Set how many times task will be
   *              executed.
   * */
   ...
   *
   * @param sync Run synchronously, if false,
   *             task will be executed asynchronously (non blockable).
   * */
   ...
   *
   * @param repeatable Is task repeatable.
   *                   By default, false.
   * */
   ...
   * */
  @Nullable Predicate<T> stopIf();

  /**
   * @return What task gonna do after complete
   * */
  @Nullable Consumer<T> afterComplete();

  /**
   * @return Task body
   * */
  @NonNull Consumer<T> body();
